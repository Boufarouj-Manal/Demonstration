<?php
	...
	$codeFiliere = isset ($_GET['fl']) ? $_GET['fl'] : "";

	$filiereDetail = $model->getFiliere($codeFiliere)->fetch_assoc();
			...
			<div class="page-content">
				...
				<div class="row clearfix">
					...
					<div class="grid_12">
						...
						<div>
							<h2 class="tac"><?php echo $filiereDetail["nom_Filiere"]; ?></h2>
						...
						<p align="justify">
							<?php
								echo $filiereDetail["Description"];
							?>
							</p>
	                      </font>
						  <br> </br>
 						<div>
							<h3>Structure du programme de la Filiere <?php echo $filiereDetail["nom_Filiere"];
								?>
							</h3>
							<hr>
						</div>
						<?php
					$resultmatierefiliere = $model->getmatieresemestre($filiereDetail["code_Filiere"]);
					function semestre($idSemestre,$libelle){
					}
					$is = 0;
					while($matierefiliere = $resultmatierefiliere->fetch_assoc()){
										?>
											 <u><h4><font color='#14778B'>
												<?php 
														if ($matierefiliere['id_Semestre'] <> $is){
															echo $matierefiliere['libelle_Semestre']."<br>" ;
														}
														$is = $matierefiliere['id_Semestre'] ;
												?>
												</font>
											</h4></u>
											...
											<h6>
	                                            <a href="matiere.php?matCode=<?php echo $matierefiliere['code_Matiere'] ?>">
												<?php echo $matierefiliere['libelle_matiere'];?> </a>
													<br> </br>
									     	</h6>			
														<?php
							}
