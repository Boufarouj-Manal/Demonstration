					...
					<div id="rev_slider_2_1" class="rev_slider fullwidthabanner" style="display:none;max-height:430px;height:430px;">
						...
						<ul>	
							...
							<li data-transition="random" data-slotamount="7" data-masterspeed="300" data-delay="10000"  data-saveperformance="off" >
								<!-- MAIN IMAGE -->
								<img src="images/5.jpg"  alt="Image Alt"  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
								</li>
								
								<!-- SLIDE  -->
							<li data-transition="random" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" >
								<!-- MAIN IMAGE -->
								<img src="images/2.jpg"  alt="Image Alt"  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
								</li>
								
							<!-- SLIDE  -->
							<li data-transition="random" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" >
								<!-- MAIN IMAGE -->
								<img src="images/33.jpg"  alt="Image Alt"  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
								</li>
							...
							<li data-transition="random" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" >
								<!-- MAIN IMAGE -->
								<img src="images/44.png"  alt="Image Alt"  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
								</li>
			...
			<div class="page-content">
				...
				<div class="row clearfix">
					...
					<div class="grid_12">
						...
						<div>
							<h2 class="tac"> Université Mundiapolis de Casablanca, 19 ans d'excellence</h2>
							<h5 class="tac">Une université ancrée en Afrique et ouverte sur le reste du monde, sa mission consiste à former et à renforcer les capacités managériales et scientifiques de l'élite de demain, contribuer à l'avancée de la recherche.</h5>
						</div>
